...
typedef hashmap<uint_t, std::pair<double, double>> phashmap;
...
void enpt2_fullci_add_terms(const TwoSpinWfn &wfn, const double *one_mo, const double *two_mo,
                            ...
                            const int_t n3, const int_t *occs_up, const int_t *occs_dn) {
...
double OneSpinWfn::compute_enpt2_doci(const double *one_mo, const double *two_mo,
                                      const double *coeffs, const double energy,
                                      const double eps) const {
  TwoSpinWfn wfn(*this);
  return wfn.compute_enpt2_fullci(one_mo, two_mo, coeffs, energy, eps);
}

double TwoSpinWfn::compute_enpt2_fullci(const double *one_mo, const double *two_mo,
                                        const double *coeffs, const double energy,
                                        const double eps) const {
...
double OneSpinWfn::compute_enpt2_genci(const double *one_mo, const double *two_mo,
                                       const double *coeffs, const double energy,
                                       const double eps) const {
  int_t nthread = omp_get_max_threads();
  phashmap terms;
