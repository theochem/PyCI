      ...
      for (j = 0; j < nvir_up; ++j) {
        ...
        for (k = 0; k < nocc_dn; ++k) {
          ...
          for (l = 0; l < nvir_dn; ++l) {
            ...
            if (jdet > idet) {
              // compute 1-1 terms
              val2 =
                  coeffs[idet] * coeffs[jdet] * sign_up * phase_single_det(nword, kk, ll, rdet_dn);
        ...
        for (k = i + 1; k < nocc_up; ++k) {
          ...
          for (l = j + 1; l < nvir_up; ++l) {
            ...
            if (jdet > idet) {
              // compute 2-0 terms
              val2 = coeffs[idet] * coeffs[jdet] * phase_double_det(nword, ii, kk, jj, ll, rdet_up);
      ...
      for (j = 0; j < nvir_dn; ++j) {
        ...
        for (k = i + 1; k < nocc_dn; ++k) {
          ...
          for (l = j + 1; l < nvir_dn; ++l) {
            ...
            if (jdet > idet) {
              // compute 2-0 terms
              val2 = coeffs[idet] * coeffs[jdet] * phase_double_det(nword, ii, kk, jj, ll, rdet_dn);
        ...
        for (k = i + 1; k < nocc; ++k) {
          ...
          for (l = j + 1; l < nvir; ++l) {
            ...
            if (jdet != -1) {
              ...
              val2 = coeffs[idet] * coeffs[jdet] * phase_double_det(nword, ii, kk, jj, ll, rdet);
