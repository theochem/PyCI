...
void OneSpinWfn::from_det_array(const int_t nbasis_, const int_t nocc_, const int_t n,
                                const uint_t *dets_) {
  init(nbasis_, nocc_);
  ndet = n;
  dets.resize(n * nword);
...
void OneSpinWfn::from_occs_array(const int_t nbasis_, const int_t nocc_, const int_t n,
                                 const int_t *occs) {
  init(nbasis_, nocc_);
  ndet = n;
  dets.resize(n * nword);
...
double OneSpinWfn::compute_overlap(const double *coeffs, const OneSpinWfn &wfn,
