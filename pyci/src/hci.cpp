...
void hci_doci_run_thread(OneSpinWfn &wfn, OneSpinWfn &thread_wfn, const double *v,
                         const double *coeffs, const double eps, const int_t istart,
                         const int_t iend) {
  if (istart >= iend)
    return;
  // set attributes
...
void hci_genci_run_thread(OneSpinWfn &wfn, OneSpinWfn &thread_wfn, const double *one_mo,
                          const double *two_mo, const double *coeffs, const double eps,
...
void hci_fullci_run_thread(TwoSpinWfn &wfn, TwoSpinWfn &thread_wfn, const double *one_mo,
                           const double *two_mo, const double *coeffs, const double eps,
                           const int_t istart, const int_t iend) {
  if (istart >= iend)
    return;
...
template <class WFN> void hci_condense_thread(WFN &wfn, WFN &thread_wfn) {
...
int_t OneSpinWfn::run_hci_genci(const double *one_mo, const double *two_mo, const double *coeffs,
                                const double eps) {
  // save ndet as ndet_old
  int_t ndet_old = ndet;
  // do computation in chunks by making smaller OneSpinWfns in parallel
...
int_t TwoSpinWfn::run_hci_fullci(const double *one_mo, const double *two_mo, const double *coeffs,
                                 const double eps) {
  // save ndet as ndet_old
  int_t ndet_old = ndet;
  // do computation in chunks by making smaller OneSpinWfns in parallel
